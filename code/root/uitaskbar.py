...
if app.ENABLE_WEREDNNBS_UIGAME:
	FACE_IMAGE_DICT = {
		playerSettingModule.RACE_WARRIOR_M	: "d:/ymir work/ui/gui/character/icon_warrior_m_01.tga",
		playerSettingModule.RACE_WARRIOR_W	: "d:/ymir work/ui/gui/character/icon_warrior_w_01.tga",
		playerSettingModule.RACE_ASSASSIN_M	: "d:/ymir work/ui/gui/character/icon_ninja_m_01.tga",
		playerSettingModule.RACE_ASSASSIN_W	: "d:/ymir work/ui/gui/character/icon_ninja_w_01.tga",
		playerSettingModule.RACE_SURA_M		: "d:/ymir work/ui/gui/character/icon_sura_m_01.tga",
		playerSettingModule.RACE_SURA_W		: "d:/ymir work/ui/gui/character/icon_sura_w_01.tga",
		playerSettingModule.RACE_SHAMAN_M	: "d:/ymir work/ui/gui/character/icon_shaman_m_01.tga",
		playerSettingModule.RACE_SHAMAN_W	: "d:/ymir work/ui/gui/character/icon_shaman_w_01.tga",
	}
...
class TaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		if constInfo.IN_GAME_SHOP_ENABLE:
			...
			self.rampageGauge1.SetEvent(ui.__mem_func__(self.__RampageGauge_Click))
			if app.ENABLE_WEREDNNBS_UIGAME:
		...
		self.tooltipHP = self.GetChild("HPGaugeTooltip")
		self.tooltipSP = self.GetChild("SPGaugeTooltip")
		self.hpRecoveryGaugeBar = self.GetChild("HPRecoveryGaugeBar")
		self.spRecoveryGaugeBar = self.GetChild("SPRecoveryGaugeBar")
		self.expGauge = self.GetChild("expGauge")
		...
		self.img.SetParent(self.GetChild("Gauge_Board"))
		self.img.SetPosition(0,-8)
		self.img.LoadImage(FACE_IMAGE_DICT[race])
		self.img.Show()
	...
	if app.ENABLE_WEREDNNBS_UIGAME:
		def SetHP(self, curPoint, recoveryPoint, maxPoint):
			...
			if maxPoint > 0:
				...
				self.tooltipHP.SetText("%d / %d" % (curPoint, maxPoint))
		...
		def SetSP(self, curPoint, recoveryPoint, maxPoint):
			...
			if maxPoint > 0:
				...
				self.tooltipSP.SetText("%d / %d" % (curPoint, maxPoint))
	...
	def OnUpdate(self):
		...
		if app.ENABLE_WEREDNNBS_UIGAME:
			# if True == self.hpGauge.IsIn():
			# 	self.tooltipHP.Show()
			# else:
			# 	self.tooltipHP.Hide()

			# if True == self.mpGauge.IsIn():
			# 	self.tooltipSP.Show()
			# else:
			# 	self.tooltipSP.Hide()
		else:
