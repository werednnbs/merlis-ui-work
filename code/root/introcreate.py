...
class CreateCharacterWindow(ui.Window):
	...
	def Open(self):
		...
		try:
			GetObject = dlgBoard.GetChild

			self.boardChar = []
			self.boardChar.append(GetObject("warrior-board"))
			self.boardChar.append(GetObject("ninja-board"))
			self.boardChar.append(GetObject("sura-board"))
			self.boardChar.append(GetObject("shamane-board"))
			...
			self.slotWar = GetObject("slot_01")
			self.slotNinja = GetObject("slot_02")
			self.slotSura = GetObject("slot_03")
			self.slotShamane = GetObject("slot_04")

			self.btnCreate = GetObject("create_button")
			# self.btnCancel = GetObject("cancel_button")

			self.genderButtonList = []
			self.genderButtonList.append(GetObject("gender_button_01"))
			self.genderButtonList.append(GetObject("gender_button_02"))

			self.shapeButtonList = []
			self.shapeButtonList.append(GetObject("shape_button_01"))
			self.shapeButtonList.append(GetObject("shape_button_02"))

			self.editCharacterName = GetObject("character_name_value")
		...
		self.slotWar.SetEvent(ui.__mem_func__(self.__SelectSlotWar))
		self.slotNinja.SetEvent(ui.__mem_func__(self.__SelectSlotNinja))
		self.slotSura.SetEvent(ui.__mem_func__(self.__SelectSlotSura))
		self.slotShamane.SetEvent(ui.__mem_func__(self.__SelectSlotShamane))
	...
	def __SelectSlotWar(self):
		self.slotWar.Down()
		self.slotNinja.SetUp()
		self.slotSura.SetUp()
		self.slotShamane.SetUp()
		self.__SelectSlot(0)

	def __SelectSlotNinja(self):
		self.slotWar.SetUp()
		self.slotNinja.Down()
		self.slotSura.SetUp()
		self.slotShamane.SetUp()
	...
	def __SelectSlotShamane(self):
		self.slotWar.SetUp()
		self.slotNinja.SetUp()
		self.slotSura.SetUp()
		self.slotShamane.Down()
		self.__SelectSlot(3)
	...
	def OnUpdate(self):
		...
		for i in xrange(4):
			...
			self.boardChar[i].SetAlpha(self.curNameAlpha[i])
