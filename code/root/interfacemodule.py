...
class Interface(object):
	...
	def __MakeChatWindow(self):
		...
		if app.ENABLE_WEREDNNBS_UIGAME:
			wndChat.SetPosition(wndMgr.GetScreenWidth()/2 - wndChat.CHAT_WINDOW_WIDTH/2, wndMgr.GetScreenHeight() - wndChat.EDIT_LINE_HEIGHT - 35)
		else:
		...
		if tokens and len(tokens):
			...
			if "item" == type:
				...
				if player.GetName() == tokens[1]:
					chat.AppendChat(chat.CHAT_TYPE_INFO, "<Sistem> Kendine Mesaj Atamazsýn.")
					return
